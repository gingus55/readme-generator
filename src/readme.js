...
const buildTableOfContents = (answers) => {
  if (
    answers.installationIncluded === "true" &&
    answers.testIncluded === "true"
  ) {
    return `
    ## Table of contents
...
const buildDescription = (answers) => `<a id="description"></a>
...
const buildGuidance = (answers) => `<a id="guidance"></a>
### User guidance
...
const buildQuestions = (answers) => `<a id="questions"></a>
### Questions 
